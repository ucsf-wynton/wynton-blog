...
author:
  - name: Erik Ellestad
    roles: Wynton SysAdmin
    affiliations:
      name: UCSF Wynton HPC Team
...
On Thursday, September 12 at 12:30 PT we will be rebooting _all_ Wynton interactive nodes to upgrade the kernel and implement RAM and CPU limits on individual user sessions. To avoid data loss, please logout and save your work before the scheduled reboot.
